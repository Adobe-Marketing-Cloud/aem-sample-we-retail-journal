...
**Note that this is not the preferred way of running the SPA project; for now, we recommend to install the [parent project](https://github.com/Adobe-Marketing-Cloud/aem-sample-we-retail-journal#install-everything) directly on your AEM instance.**
